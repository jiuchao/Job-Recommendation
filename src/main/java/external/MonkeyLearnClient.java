...
public class MonkeyLearnClient {
	private static final String API_KEY = "a3f51a5423df63405337a6eaef001228b8a26d18";// make sure change it to your api key.
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		//List<List<String>> for batch process, provide keywords for all the jobs
		//List<List<String>> can be easier to be saved to database
